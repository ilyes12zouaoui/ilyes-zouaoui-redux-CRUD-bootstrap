    ...
    >
      <div className="container text-center">
        ...
        <p className="lead">
          ...
          simple way, this project was made for learning how to manage our react
          application state in a more efficient way using redux, i wish it helps
          you.
        </p>
      </div>
    </div>
